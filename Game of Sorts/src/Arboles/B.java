...
public class B
{
    ...
    public void setTengoHijos (BNodo nodo) {
        if (nodo == primerNodo) {
    ...
    public void ingresarEnHijos(BNodo conHijos, int valor) {
        boolean entro = false;
    ...
    public void ubicarValorEnArreglo(BNodo nodoA, int valor){
        int cont = 0;
        while(cont <= 2*grado){
     ...
     public void ordenarNodos(BNodo aOrdenar){
       int i,j;
       i = 0;
       BNodo tmp;
    ...
    public void split (BNodo nodo) {
       
        BNodo hijoIzq = new BNodo();
        BNodo hijoDer = new BNodo();
    ...
    public String recorrer(BNodo nodo) {
         arbol += "\n";
...
/*
Del siguiente link fue tomado parte del codigo anterior ara eliminar 
cualquier comentario referencia a plagio
http://www.preguntaslinux.org/algoritmo-arbol-b-codificado-en-java-t-3338.html
*/
